        ...
        <div class="sort-cate">
            <div class="sort-left">
                ...
                <form action="?index.php?ctr=tourDL" method="post">
                    <li><input type="radio" onclick="window.location= '?ctr=A-Z';" name="sort" id="id1"  />Tên A - Z</li>
                    ...
                    <li><input type="radio" onclick="window.location= '?ctr=giamdan';" name="sort" id=""  checked />Giá giảm dần</li>
                </form>
