...
<main id="content" role="main" class="main">
  ...
  <div class="content container-fluid">
          ...
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-no-gutter">
              <li class="breadcrumb-item">
                <a class="breadcrumb-link" href="ecommerce-products.html">Customers</a>
              </li>
    ...
    <form method="POST" enctype="multipart/form-data" action="?ctr=edit-customer">
      <div class="row">
        <div class="col-lg-8">
          <!-- Card -->
          <div class="card mb-3 mb-lg-5">
            ...
            <!-- Body -->
            <div class="card-body">
              <input type="hidden" name="id_users" value="<?= $customer['id_users'] ?>">
              <!-- Form Group -->
              <div class="form-group">
                <label for="productNameLabel" class="input-label">Họ tên
                ...
                <input type="text" class="form-control" name="hoten" id="productNameLabel" value="<?= $customer['hoten'] ?>" />
              ...
              <div class="form-group">
                <label for="productNameLabel" class="input-label">Tên đăng nhập
                  <i class="tio-help-outlined text-body ml-1" data-toggle="tooltip" data-placement="top" title="Products are the goods or services you sell."></i></label>
                <input type="text" class="form-control" name="user_name" id="productNameLabel" value="<?= $customer['user_name'] ?>" />
              ...
              <div class="form-group">
                ...
                <img src="views/admin/assets/img/160x160/<?= $customer['image'] ?>" width="100" style="border-radius: 7px;" alt="">
                        ...
                        <div class="row">
                          <div class="col-12">
                            <div class="input-group-prepend">
                              <input type="text" class="form-control" name="sdt" id="productNameLabel" value="<?= $customer['sdt'] ?>" />
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="js-add-field">
                      ...
                      <div class="form-group">
                        <div class="row">
                          <div class="col-12">
                            <div class="input-group-prepend">
                              <input type="text" class="form-control" name="email" id="productNameLabel" value="<?= $customer['email'] ?>" /> 
                            </div>
                          </div>
                        </div>
                      </div>
              ...
              <div class="row">
                <div class="col-sm-6">
                  <!-- Form Group -->
                  <div class="form-group">
                    <label for="SKULabel" class="input-label">Địa chỉ</label>
                    <div class="js-add-field">
                      <!-- Form Group -->
                      <div class="form-group">
                        <div class="row">
                          <div class="col-12">
                            <div class="input-group-prepend">
                              <input type="text" class="form-control" name="diachi" id="productNameLabel" value="<?= $customer['diachi'] ?>" /> 
                            </div>
                          </div>
                        </div>
                      </div>
                          ...
                          <div class="col-12">
                            <div class="input-group-prepend">
                              ...
                              <select class="js-select2-custom custom-select" name="gioitinh" size="1" style="opacity: 0" data-hs-select2-options='{
                                ...
                                <?php $gt = ['Nam','Nữ'] ?>
                                <?php foreach($gt as $gt_user) : ?>
                                  <option value="<?= $gt_user ?>" <?= ($gt_user == $customer['gioitinh']) ? 'selected' : '' ?>>
                                    <?= check_gioi_tinh($gt_user) ?>
                                  </option>
                                <?php endforeach ?>
                              </select>
                              <!-- End Select --> 
