    ...
    <div class="page-header">
      <div class="row align-items-center">
        <div class="col-sm mb-2 mb-sm-0">
          ...
          <h1 class="page-header-title">Add slide</h1>
        </div>
      </div>
      <!-- End Row -->  
    </div>
    <!-- End Page Header -->
    <form action="?ctr=save_add_slide" method="POST" enctype="multipart/form-data">
      <div class="row">
        <div class="col-lg-8">
          <!-- Card -->
          <div class="card mb-3 mb-lg-5">
            ...
            <div class="card-body">
              ...
              <div class="form-group" style="margin-bottom: 0;">
                ...
                <textarea id="my-textarea" class="form-control" name="desc_slide" rows="5"></textarea>
              </div>
              <!-- End Form Group -->
            </div>
            <!-- Body -->
