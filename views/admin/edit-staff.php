...
<main id="content" role="main" class="main">
  ...
  <div class="content container-fluid">
    ...
    <form method="POST" enctype="multipart/form-data" action="?ctr=edit-staff">
      <div class="row">
        <div class="col-lg-8">
          <!-- Card -->
          <div class="card mb-3 mb-lg-5">
            ...
            <!-- Body -->
            <div class="card-body">
              <input type="hidden" name="id_users" value="<?= $staff['id_users'] ?>">
              <!-- Form Group -->
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="hoten" id="productNameLabel" value="<?= $staff['hoten'] ?>" />
              ...
              <div class="form-group">
                <label for="productNameLabel" class="input-label">Tên đăng nhập
                  <i class="tio-help-outlined text-body ml-1" data-toggle="tooltip" data-placement="top" title="Products are the goods or services you sell."></i></label>
                <input type="text" class="form-control" name="user_name" id="productNameLabel" value="<?= $staff['user_name'] ?>" />
              ...
              <div class="form-group">
                ...
                <img src="views/admin/assets/img/160x160/<?= $staff['image'] ?>" width="100" style="border-radius: 7px;" alt="">
                        ...
                        <div class="row">
                          <div class="col-12">
                            <div class="input-group-prepend">
                              <input type="text" class="form-control" name="sdt" id="productNameLabel" value="<?= $staff['sdt'] ?>" />
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="js-add-field">
                      ...
                      <div class="form-group">
                        <div class="row">
                          <div class="col-12">
                            <div class="input-group-prepend">
                              <input type="text" class="form-control" name="email" id="productNameLabel" value="<?= $staff['email'] ?>" /> 
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="js-add-field">
                      ...
                      <div class="form-group">
                        <div class="row">
                          <div class="col-12">
                            <div class="input-group-prepend">
                              <input type="text" class="form-control" name="diachi" id="productNameLabel" value="<?= $staff['diachi'] ?>" /> 
                            </div>
                          </div>
                        </div>
                      </div>
                            ...
                            <div class="input-group-prepend">
                              ...
                              <select class="js-select2-custom custom-select" name="gioitinh" size="1" style="opacity: 0" data-hs-select2-options='{
                                ...
                                <?php foreach($gt as $gt_user) : ?>
                                  <option value="<?= $gt_user ?>" <?= ($gt_user == $staff['gioitinh']) ? 'selected' : '' ?>>
