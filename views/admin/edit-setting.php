          ...
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-no-gutter">
              <li class="breadcrumb-item">
                <a class="breadcrumb-link" href="ecommerce-products.html">Settings</a>
              </li>
        ...
        <div class="col-lg-8">
          ...
          <div class="card mb-3 mb-lg-5">
            ...
            <div class="card-header">
              <h4 class="card-header-title">Setting Information</h4>
            </div>
            <!-- End Header -->
            ...
            <div class="card-body">
              ...
              <div class="form-group" style="margin-bottom: 0;">
                ...
                <div class="form-group">
                  ...
                  <label for="exampleInput" class="input-label">Logo</label>
                  <img src="layout/images/<?= $setting['logo'] ?>" width="100" style="border-radius: 7px;" alt="">
                  <div class="custom-file">
                    <input type="file" class="custom-file-input" name="logo" id="exampleInput">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="dia_chi" id="productNameLabel" placeholder="Nhập địa chỉ" value="<?= $setting['dia_chi']?>" />
                </div>
                <!-- End Form Group -->
                <!-- Form Group -->
                <div class="form-group">
                  <label for="productNameLabel" class="input-label">Phone number
                  <input type="text" class="form-control" name="sdt" id="productNameLabel" placeholder="Nhập số điện thoại" value="<?= $setting['sdt']?>" />
                </div>
                <!-- End Form Group -->
                <div class="form-group">
                  <label for="productNameLabel" class="input-label">Email
                  <input type="text" class="form-control" name="email" id="productNameLabel" placeholder="Nhập email" value="<?= $setting['email']?>" />
                </div>
                <!-- End Form Group -->
                <!-- End Form Group -->
                <div class="form-group">
                  <label for="productNameLabel" class="input-label">Zalo
                  <input type="text" class="form-control" name="zalo" id="productNameLabel" placeholder="Nhập số zalo" value="<?= $setting['zalo']?>" />
                </div>
                <!-- End Form Group -->
                <!-- End Form Group -->
                <div class="form-group">
                  <label for="productNameLabel" class="input-label">Copyright
                  <input type="text" class="form-control" name="copyright" id="productNameLabel" placeholder="Nhập copyright" value="<?= $setting['copyright']?>" />
                </div>
                <!-- End Form Group -->
              </div>
              <!-- End Form Group -->
