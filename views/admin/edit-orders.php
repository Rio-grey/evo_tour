...
<main id="content" role="main" class="main">
  ...
  <div class="content container-fluid">
          ...
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-no-gutter">
              <li class="breadcrumb-item">
                <a class="breadcrumb-link" href="ecommerce-products.html">Orders</a>
              </li>
    ...
    <form method="POST" enctype="multipart/form-data" action="?ctr=edit-orders">
      <div class="row">
        <div class="col-lg-8">
          <!-- Card -->
          <div class="card mb-3 mb-lg-5">
            ...
            <div class="card-header">
              <h4 class="card-header-title">Order information</h4>
            </div>
            <!-- End Header -->
            <!-- Body -->
            <div class="card-body">
              <input type="hidden" name="id_booking_detail" value="<?= $order['id_booking_detail'] ?>">
              <div class="row">
                <div class="col-sm-6">
                  <!-- Form Group -->
                  <div class="form-group">
                    <label for="SKULabel" class="input-label">Trạng thái đơn hàng</label>
                        ...
                        <div class="row">
                          <div class="col-12">
                            <div class="input-group-prepend">
                              <!-- Select -->
                              <select class="js-select2-custom custom-select" name="status" size="1" style="opacity: 0" data-hs-select2-options='{
                                      "minimumResultsForSearch": "Infinity"
                                    }'>
                                <?php $ttdh = ['0','1','2','3'] ?>
                                <?php foreach($ttdh as $tt_dh) : ?>
                                  <option value="<?= $tt_dh ?>" <?= ($tt_dh == $order['status']) ? 'selected' : '' ?>>
                                    <?= check_trang_thai_don_hang($tt_dh) ?>
                                  </option>
                                <?php endforeach ?>
                              </select>
                              <!-- End Select --> 
