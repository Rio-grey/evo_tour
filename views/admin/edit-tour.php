...
<main id="content" role="main" class="main">
  ...
  <div class="content container-fluid">
    ...
    <form method="POST" enctype="multipart/form-data" action="?ctr=edit-tour">
      <div class="row">
        <div class="col-lg-8">
          <!-- Card -->
          <div class="card mb-3 mb-lg-5">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="name_tour" id="productNameLabel" aria-label="Shirt, t-shirts, etc." value="<?= $tour['name_tour'] ?>" />
              ...
              <div class="form-group">
                ...
                <img src="layout/images/products/<?= $tour['image'] ?>" width="100" style="border-radius: 7px;" alt="">
                <div class="custom-file">
                  <input type="file" class="custom-file-input" style="opacity: 1;" name="image" id="exampleInput">
                          ...
                          <div class="col-12">
                            <div class="input-group-prepend">
                              ...
                              <select class="js-select2-custom custom-select" name="lich_khoi_hanh" size="1" style="opacity: 0" data-hs-select2-options='{
                                ...
                                <?php $lkh = ['Thứ 2 hàng tuần','Thứ 3 hàng tuần','Thứ 4 hàng tuần','Thứ 5 hàng tuần','Thứ 6 hàng tuần','Thứ 7 hàng tuần','Chủ nhật hàng tuần'] ?>
                                <?php foreach($lkh as $lkh_tour) : ?>
                                  <option value="<?= $lkh_tour ?>" <?= ($lkh_tour == $tour['lich_khoi_hanh']) ? 'selected' : '' ?>>
                                    <?= check_lich_khoi_hanh($lkh_tour) ?>
                                  </option>
                                <?php endforeach ?>
                              </select>
                              <!-- End Select -->
                          ...
                          <div class="col-12">
                            <div class="input-group-prepend">
                              ...
                              <select class="js-select2-custom custom-select" name="thoi_gian" size="1" style="opacity: 0" data-hs-select2-options='{
                                ...
                                <?php $tg = ['2 ngày 1 đêm','3 ngày 2 đêm','4 ngày 3 đêm','5 ngày 4 đêm','6 ngày 5 đêm','7 ngày 6 đêm'] ?>
                                <?php foreach($tg as $tg_tour) : ?>
                                  <option value="<?= $tg_tour ?>" <?= ($tg_tour == $tour['thoi_gian']) ? 'selected' : '' ?>>
                                    <?= check_thoi_gian($tg_tour) ?>
                                  </option>
                                <?php endforeach ?>
                              </select>
                              <!-- End Select -->
                          ...
                          <div class="col-12">
                            <div class="input-group-prepend">
                              ...
                              <select class="js-select2-custom custom-select" name="khoi_hanh_tu" size="1" style="opacity: 0" data-hs-select2-options='{
                                ...
                                <?php $kht = ['TP.Hồ Chí Minh','TP.Huế','Đà Nẵng','Hà Nội','Quảng Ninh','Hải Phòng','Cần Thơ','Nghệ An','Khánh Hòa','Lâm Đồng','Bình Định','Kiên Giang','Đồng Nai'] ?>
                                <?php foreach($kht as $kht_tour) : ?>
                                  <option value="<?= $kht_tour ?>" <?= ($kht_tour == $tour['khoi_hanh_tu']) ? 'selected' : '' ?>>
                                    <?= check_khoi_hanh_tu($kht_tour) ?>
                                  </option>
                                <?php endforeach ?>    
                              </select>
                              <!-- End Select -->
                          ...
                          <div class="col-12">
                            <div class="input-group-prepend">
                              ...
                              <select class="js-select2-custom custom-select" name="phuong_tien" size="1" style="opacity: 0" data-hs-select2-options='{
                                ...
                                <?php $pt = ['Máy bay.svg','Ô tô.svg','Tàu thủy.svg'] ?>
                                <?php foreach($pt as $pt_tour) : ?>
                                  <option value="<?= $pt_tour ?>" <?= ($pt_tour == $tour['phuong_tien']) ? 'selected' : '' ?>>
                                    <?= check_phuong_tien($pt_tour) ?>
                                  </option>
                                <?php endforeach ?>
                              </select>
                              <!-- End Select -->
              ...
              <textarea name="chuong_trinh" class="desc" cols="30" rows="15"><?= $tour['chuong_trinh'] ?></textarea>
              ...
              <label class="input-label">Chính sách tour
                <span class="input-label-secondary">(Optional)</span></label>
              <textarea name="chinh_sach" class="desc" cols="30" rows="15"><?= $tour['chinh_sach'] ?></textarea>
              ...
              <label class="input-label">Điều khoản và quy định
                <span class="input-label-secondary">(Optional)</span></label>
              <textarea name="dieu_khoan" class="desc" cols="30" rows="15"><?= $tour['dieu_khoan'] ?></textarea>
              ...
              <label class="input-label">Description
                <span class="input-label-secondary">(Optional)</span></label>
                <textarea name="description" class="desc" cols="30" rows="15"><?= $tour['description'] ?></textarea>
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  <input type="text" class="form-control" value="<?= $tour['price'] ?>" name="price" id="priceNameLabel" placeholder="0.00" aria-label="0.00" />
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  <input type="text" class="form-control" value="<?= $tour['sale_price'] ?>" name="sale_price" id="priceNameLabel" placeholder="0.00" aria-label="0.00" />
                  <div class="input-group-append">
                    <!-- Select -->
                    <div id="priceSelect" class="select2-custom select2-custom-right">
                      <select class="js-select2-custom custom-select" size="1" style="opacity: 0" data-hs-select2-options='{
              ...
              <div class="form-group">
                ...
                <select class="js-select2-custom custom-select" size="1" name="id_loai_tour" style="opacity: 0" id="categoryLabel" data-hs-select2-options='{
                  ...
                  <?php foreach ($category as $cate) : ?>
                    <option value="<?= $cate['id_loai_tour'] ?>" <?php echo ($cate['id_loai_tour'] == $tour['id_loai_tour'] ? 'selected' : '') ?>>
                      <?= $cate['ten_loai_tour'] ?>
                    </option>
                  <?php endforeach ?>  
                </select>
