<?php include_once "views\admin\header_admin.php" ?>
    ...
    <main id="content" role="main" class="main">
      ...
      <div class="content container-fluid">
        ...
        <div class="page-header">
          <div class="row align-items-center">
            <div class="col-sm mb-2 mb-sm-0">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-no-gutter">
                  <li class="breadcrumb-item">
                    <a class="breadcrumb-link" href="ecommerce-products.html"
                      >Posts</a
                    >
                  </li>
              ...
              <h1 class="page-header-title">Add posts</h1>
            </div>
          </div>
          <!-- End Row -->
        </div>
        ...
        <form method="POST" enctype="multipart/form-data" action="?ctr=edit-news">
          <div class="row">
            <div class="col-lg-8">
              <!-- Card -->
              <div class="card mb-3 mb-lg-5">
                ...
                <div class="card-body">
                  ...
                  >
                  <textarea name="title_news" class="desc" cols="30" rows="10"><?= $news['title_news'] ?></textarea>
                  <small style="margin: 10px 15px 0; display: block; font-size: small;" class="text-danger"><?= isset($errors['title_news']) ? $errors['title_news'] : '' ?></small>
                  <br>
                  <label class="input-label"
                    >Nội dung bài viết
                    <span class="input-label-secondary">(Optional)</span></label
                  >
                  <textarea name="desc_news" class="desc" cols="30" rows="15"><?= $news['desc_news'] ?></textarea>
                  <small style="margin: 10px 15px 0; display: block; font-size: small;" class="text-danger"><?= isset($errors['desc_news']) ? $errors['desc_news'] : '' ?></small>
                  <br>
                  <!-- Form Group -->
                  <div class="form-group">
                    <input type="hidden" name="image" value="<?= $news['image'] ?>">
                    <label class="input-label">Image</label>
                    <img src="layout/images/products/<?= $news['image'] ?>" width="100" style="border-radius: 7px;" alt="">
        ...
        <!-- End Row -->
          ...
          >
            ...
            <div class="card card-sm bg-dark border-dark mx-2">
              <div class="card-body">
                <div
                  class="row justify-content-center justify-content-sm-between"
                >
                  <div class="col">
    ...
    <div
      class="modal fade"
      id="addImageFromURLModal"
      tabindex="-1"
      role="dialog"
      aria-labelledby="addImageFromURLModalTitle"
      aria-hidden="true"
    >
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <label for="pasteImageURLNameLabel" class="input-label"
    ...
    <div
      ...
      tabindex="-1"
      role="dialog"
      aria-labelledby="embedVideoModalTitle"
      aria-hidden="true"
    >
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <!-- Body -->
          <div class="modal-body">
            <label for="pasteVideoURLNameLabel" class="input-label"
              >Paste video URL</label
            >
            <input
              type="text"
              class="form-control"
              name="projectName"
              id="pasteVideoURLNameLabel"
              placeholder="https://"
              aria-label="https://"
            />
          </div>
    ...
    <div
      class="modal fade"
      id="productsAdvancedFeaturesModal"
      tabindex="-1"
      role="dialog"
      aria-hidden="true"
    >
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="d-sm-flex">
              <img
                class="avatar avatar-xl avatar-4by3 mb-3 mb-sm-0 mr-4"
                src="views\admin\assets\svg\illustrations\choice.svg"
                alt="Image Description"
              />
            ...
            <div class="d-sm-flex">
              <img
                class="avatar avatar-xl avatar-4by3 mb-3 mb-sm-0 mr-4"
                src="views\admin\assets\svg\illustrations\presenting.svg"
                alt="Image Description"
              />
            ...
            <div class="d-sm-flex">
              <img
                class="avatar avatar-xl avatar-4by3 mb-3 mb-sm-0 mr-4"
                src="views\admin\assets\svg\illustrations\book.svg"
                alt="Image Description"
              />
