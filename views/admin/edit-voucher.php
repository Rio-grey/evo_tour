...
<main id="content" role="main" class="main">
  ...
  <div class="content container-fluid">
    ...
    <div class="page-header">
      <div class="row align-items-center">
        <div class="col-sm mb-2 mb-sm-0">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-no-gutter">
              <li class="breadcrumb-item">
                <a class="breadcrumb-link" href="ecommerce-products.html">Vouchers</a>
              </li>
          ...
          <h1 class="page-header-title"><?= $voucher['code_voucher'] ?></h1>
    ...
    <!-- End Page Header -->
    <form action="?ctr=edit-voucher" method="POST" enctype="multipart/form-data">
      <div class="row">
        <div class="col-lg-8">
          <!-- Card -->
          <div class="card mb-3 mb-lg-5">
            ...
            <div class="card-header">
              <h4 class="card-header-title">Voucher information</h4>
            </div>
            <!-- End Header -->
            ...
            <div class="card-body">
              ...
              <div class="form-group" style="margin-bottom: 0;">
                <label for="productNameLabel" class="input-label">Mã giảm giá
                ...
                <input type="text" class="form-control" name="code_voucher" id="productNameLabel" placeholder="Nhập mã giảm giá" value="<?= $voucher['code_voucher'] ?>"/>
                <small style="margin: 10px 15px 0; display: block; font-size: small;" class="text-danger"><?= isset($errors['code_voucher']) ? $errors['code_voucher'] : '' ?></small>
              </div>
              <!-- End Form Group -->
              <br>
              <!-- Form Group -->
              <div class="form-group" style="margin-bottom: 0;">
                <label for="productNameLabel" class="input-label">Ngày bắt đầu có hiệu lực
                <input type="date" class="form-control" name="ngay_bat_dau" id="productNameLabel" value="<?= $voucher['ngay_bat_dau'] ?>"/>
                <small style="margin: 10px 15px 0; display: block; font-size: small;" class="text-danger"><?= isset($errors['ngay_bat_dau']) ? $errors['ngay_bat_dau'] : '' ?></small>
              </div>
              <br>
              <!-- End Form Group -->
              <!-- Form Group -->
              <div class="form-group" style="margin-bottom: 0;">
                <label for="productNameLabel" class="input-label">Ngày hết hạn
                <input type="date" class="form-control" name="ngay_het_han" id="productNameLabel" value="<?= $voucher['ngay_het_han'] ?>"/>
                <small style="margin: 10px 15px 0; display: block; font-size: small;" class="text-danger"><?= isset($errors['ngay_het_han']) ? $errors['ngay_het_han'] : '' ?></small>
              </div>
              <!-- End Form Group -->
              <br>
              <!-- Form Group -->
              <div class="form-group" style="margin-bottom: 0;">
                <label for="productNameLabel" class="input-label">Giá trị của mã
                <input type="text" class="form-control" name="value" id="productNameLabel" value="<?= $voucher['value'] ?>"/>
                <small style="margin: 10px 15px 0; display: block; font-size: small;" class="text-danger"><?= isset($errors['value']) ? $errors['value'] : '' ?></small>
              </div>
              <!-- End Form Group -->
            </div>
            <!-- Body -->
