    ...
    <div class="page-header">
      <div class="row align-items-center">
        <div class="col-sm mb-2 mb-sm-0">
          ...
          <h1 class="page-header-title">Add voucher</h1>
        </div>
      </div>
      <!-- End Row -->  
    </div>
    <!-- End Page Header -->
    <form action="?ctr=save_add_voucher" method="POST" enctype="multipart/form-data">
      <div class="row">
        <div class="col-lg-8">
          <!-- Card -->
          <div class="card mb-3 mb-lg-5">
            ...
            <div class="card-body">
              ...
              <div class="form-group" style="margin-bottom: 0;">
                ...
                <input type="text" class="form-control" name="code_voucher" id="productNameLabel" placeholder="Nhập mã giảm giá"/>
              ...
              <div class="form-group" style="margin-bottom: 0;">
                ...
                <input type="date" class="form-control" name="ngay_bat_dau" id="productNameLabel"/>
              ...
              <div class="form-group" style="margin-bottom: 0;">
                ...
                <input type="date" class="form-control" name="ngay_het_han" id="productNameLabel"/>
              ...
              <div class="form-group" style="margin-bottom: 0;">
                ...
                <input type="text" class="form-control" name="value" id="productNameLabel"/>
