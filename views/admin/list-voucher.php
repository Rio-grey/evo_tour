    ...
    <div class="page-header">
      <div class="row align-items-center mb-3">
        <div class="col-sm mb-2 mb-sm-0">
          <h1 class="page-header-title">
            Vouchers
            <span class="badge badge-soft-dark ml-2"><?= count($all_voucher) ?></span>
          </h1>
        ...
        <div class="col-sm-auto">
          <a class="btn btn-primary" href="?ctr=add-voucher">Add voucher</a>
        </div>
      </div>
      <!-- End Row -->
      ...
      <div class="js-nav-scroller hs-nav-scroller-horizontal">
        ...
        <ul class="nav nav-tabs page-header-tabs" id="pageHeaderTab" role="tablist">
          <li class="nav-item">
            <a class="nav-link active" href="#">All vouchers</a>
          </li>
          <li class="nav-item">
          ...
          <div class="col-md-4 mb-3 mb-md-0">
            <form>
              ...
              <div class="input-group input-group-merge input-group-flush">
                ...
                <input id="datatableSearch" type="search" class="form-control" placeholder="Search voucher" aria-label="Search voucher" />
              </div>
              <!-- End Search -->
            </form>
          </div>
          ...
          <div class="col-auto">
            ...
            <div class="hs-unfold">
              <a class="js-hs-unfold-invoker btn btn-white" href="javascript:;" data-hs-unfold-options='{
                ...
                <span class="badge badge-soft-dark rounded-circle ml-1">3</span>
              </a>
                ...
                <div class="card card-sm">
                  <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                      <span class="mr-2">Code Voucher</span>
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                      <span class="mr-2">Effective Date</span>
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                      <span class="mr-2">Out of Date</span>
        ...
        <table id="datatable" class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table" data-hs-datatables-options='{
          ...
          <thead class="thead-light">
            <tr>
              ...
              <th class="table-column-pl-0">Code Voucher</th>
          ...
          <tbody>
            <?php foreach ($all_voucher as $voucher) : ?>
              <tr>
                ...
                <td class="table-column-pl-0">
                  <span class="media align-items-center">
                    <div class="media-body">
                      <h5 class="text-hover-primary mb-0"><?= $voucher['code_voucher'] ?></h5>
                    </div>
                  </span>
                </td>
                <td><?= $voucher['ngay_bat_dau'] ?></td>
                <td><?= $voucher['ngay_het_han'] ?></td>
                <td>Giảm giá <?= $voucher['value'] ?>%</td>
                <td>
                  <div class="btn-group" role="group">
                    <a class="btn btn-sm btn-outline-primary" href="?ctr=update-voucher&id_voucher=<?= $voucher['id_voucher'] ?>">
                      <i class="tio-edit"></i> Edit
                    </a>
                  </div>
                  <div class="btn-group" role="group">
                    <a class="btn btn-sm btn-outline-danger" onclick="return confirm('Bạn có chắc chắn muốn xóa không ?')" href="?ctr=delete-voucher&id_voucher=<?= $voucher['id_voucher'] ?>">
                      <i class="tio-delete-outlined"></i> Delete
                    </a>
                  </div>
                </td>
