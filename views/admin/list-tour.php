    ...
    <div class="page-header">
      <div class="row align-items-center mb-3">
        <div class="col-sm mb-2 mb-sm-0">
          <h1 class="page-header-title">
            Tours <span class="badge badge-soft-dark ml-2"><?= count($count_tours) ?></span>
          </h1>
        ...
        <div class="col-sm-auto">
          <a class="btn btn-primary" href="?ctr=add-tour">Add tour</a>
        </div>
      </div>
      <!-- End Row -->
      ...
      <div class="js-nav-scroller hs-nav-scroller-horizontal">
        ...
        <ul class="nav nav-tabs page-header-tabs" id="pageHeaderTab" role="tablist">
          <li class="nav-item">
            <a class="nav-link active" href="#">All tours</a>
          </li>
          <li class="nav-item">
          ...
          <div class="col-md-4 mb-3 mb-md-0">
            <form>
              ...
              <div class="input-group input-group-merge input-group-flush">
                ...
                <input id="datatableSearch" type="search" class="form-control" placeholder="Search tours" aria-label="Search tours" />
              </div>
              <!-- End Search -->
            </form>
          </div>
              ...
              <div id="showHideDropdown" class="hs-unfold-content dropdown-unfold dropdown-menu dropdown-menu-right dropdown-card" style="width: 15rem">
                <div class="card card-sm">
                  <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                      <span class="mr-2">Lịch khởi hành</span>
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                      <span class="mr-2">Khởi hành từ</span>
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                      <span class="mr-2">Phương tiện</span>
        ...
        <table id="datatable" class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table" data-hs-datatables-options='{
          ...
          <thead class="thead-light">
            <tr>
              ...
              <th class="table-column-pl-0">Tour</th>
              <th>Giá tour</th>
              <th>Giá giảm</th>
            ...
            <?php foreach ($all_tours as $tour) : ?>
              <tr>
                ...
                <td class="table-column-pl-0">
                  <a class="media align-items-center" href="?ctr=update-tour&id_tour=<?= $tour['id_tour'] ?>">
                    <img class="avatar avatar-lg mr-3" src="layout/images/products/<?= $tour['image'] ?>" alt="Image Description" />
                ...
                <td><?= $tour['lich_khoi_hanh'] ?></td>
                <td><?= $tour['thoi_gian'] ?></td>
                <td><?= $tour['khoi_hanh_tu'] ?></td>
                <td><?= $tour['phuong_tien'] ?></td>
                <td><?= $tour['ten_loai_tour'] ?></td>
                <td>
                  <div class="btn-group" role="group">
                    <a class="btn btn-sm btn-outline-primary" href="?ctr=update-tour&id_tour=<?= $tour['id_tour'] ?>">
                      <i class="tio-edit"></i> Edit
                    </a>
                  </div>
                  <div class="btn-group" role="group">
                    <a class="btn btn-sm btn-outline-danger" onclick="return confirm('Bạn có chắc chắn muốn xóa không ?')" href="?ctr=delete-tour&id_tour=<?= $tour['id_tour'] ?>">
                      <i class="tio-delete-outlined"></i> Delete
                    </a>
                  </div>
                </td>
