...
<main id="content" role="main" class="main">
  ...
  <div class="content container-fluid">
    ...
    <div class="page-header">
      <div class="row align-items-center">
        <div class="col-sm mb-2 mb-sm-0">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-no-gutter">
              <li class="breadcrumb-item">
                <a class="breadcrumb-link" href="ecommerce-products.html">Slides</a>
              </li>
          ...
          <h1 class="page-header-title"><?= $slide['desc_slide'] ?></h1>
    ...
    <!-- End Page Header -->
    <form action="?ctr=edit-slide" method="POST" enctype="multipart/form-data">
      <div class="row">
        <div class="col-lg-8">
          <!-- Card -->
          <div class="card mb-3 mb-lg-5">
            ...
            <div class="card-header">
              <h4 class="card-header-title">Slide information</h4>
            </div>
            <!-- End Header -->
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <label for="exampleInput" class="input-label">Image slide</label>
                <img src="layout/images/<?= $slide['image'] ?>" width="100" style="border-radius: 7px;" alt="">
              ...
              <div class="form-group" style="margin-bottom: 0;">
                <label for="my-textarea" class="input-label">Mô tả slide
                <textarea id="my-textarea" class="form-control" name="desc_slide" rows="5"><?= $slide['desc_slide'] ?></textarea>
              </div>
              <!-- End Form Group -->
            </div>
            <!-- Body -->
