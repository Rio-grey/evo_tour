    ...
    <div class="page-header">
      <div class="row align-items-center mb-3">
        <div class="col-sm mb-2 mb-sm-0">
          <h1 class="page-header-title">
            Contact <span class="badge badge-soft-dark ml-2"><?= count($count_contact) ?></span>
          </h1>
      ...
      <div class="js-nav-scroller hs-nav-scroller-horizontal">
        ...
        <ul class="nav nav-tabs page-header-tabs" id="pageHeaderTab" role="tablist">
          <li class="nav-item">
            <a class="nav-link active" href="#">All contact</a>
          </li>
          <li class="nav-item">
          ...
          <div class="col-auto">
            ...
            <div class="hs-unfold">
              <a class="js-hs-unfold-invoker btn btn-white" href="javascript:;" data-hs-unfold-options='{
                ...
                <span class="badge badge-soft-dark rounded-circle ml-1">4</span>
              </a>
              ...
              <div id="showHideDropdown" class="hs-unfold-content dropdown-unfold dropdown-menu dropdown-menu-right dropdown-card" style="width: 15rem">
                <div class="card card-sm">
                  <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                      <span class="mr-2">Nội dung liên hệ</span>
          ...
          <tbody>
            <?php foreach ($all_contact as $contact) : ?>
              <tr>
                ...
                <td><?= $contact['noi_dung_lien_he'] ?></td>
                <!-- <td>
