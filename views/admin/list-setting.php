    ...
    <div class="page-header">
      <div class="row align-items-center mb-3">
        ...
        <div class="col-sm-auto">
          <a class="btn btn-primary" href="?ctr=add-category">Add settings</a>
        </div>
      </div>
      <!-- End Row -->
      ...
      <div class="js-nav-scroller hs-nav-scroller-horizontal">
        ...
        <ul class="nav nav-tabs page-header-tabs" id="pageHeaderTab" role="tablist">
          <li class="nav-item">
            <a class="nav-link active" href="#">All settings</a>
          </li>
          <li class="nav-item">
          ...
          <div class="col-md-4 mb-3 mb-md-0">
            <form>
              ...
              <div class="input-group input-group-merge input-group-flush">
                ...
                <input id="datatableSearch" type="search" class="form-control" placeholder="Search settings" aria-label="Search settings" />
              </div>
              <!-- End Search -->
            </form>
          </div>
        ...
        <table id="datatable" class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table" data-hs-datatables-options='{
          ...
          <thead class="thead-light">
            <tr>
              ...
              <th class="table-column-pl-0">Logo</th>
              <th>Address</th>
              <th>Phone Number</th>
              <th>Zalo</th>
              <th>Email</th>
              ...
              <tr>
                ...
                <td class="table-column-pl-0">
                  <span class="media align-items-center">
                    <img class="avatar avatar-lg mr-3" src="./layout/images/<?= $item['logo']?>" />
                    <div class="media-body">
                      <!-- <h5 class="text-hover-primary mb-0"><?= $item['dia_chi'] ?></h5> -->
                    </div>
                  </span>
                </td>
                <td><div class="text-wrap" style="width: 18rem"><?= $item['dia_chi'] ?></div></td>
                <td><?= $item['sdt'] ?></td>
                <td><?= $item['zalo'] ?></td>
                <td><?= $item['email'] ?></td>
                <td><div class="text-wrap" style="width: 18rem"><?= $item['copyright'] ?></div></td>
                <td>
                  <div class="btn-group" role="group">
                    <a class="btn btn-sm btn-outline-primary" href="?ctr=update-setting&id_setting=<?= $item['id_setting']?>">
