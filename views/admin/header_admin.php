...
<head>
  ...
  <link rel="stylesheet" href="views\admin\assets\css\vendor.min.css" />
  <link rel="stylesheet" href="views\admin\assets\vendor\icon-set\style.css" />

  <!-- CSS Front Template -->
  <link rel="stylesheet" href="views\admin\assets\css\theme.min.css?v=1.0" />
  
</head>

<body class="footer-offset">
  <script src="views\admin\assets\\vendor\hs-navbar-vertical-aside\hs-navbar-vertical-aside-mini-cache.js"></script>
            ...
            <div class="text-center">
              <div class="custom-checkbox-card mb-2">
                ...
                <label class="custom-checkbox-card-label" for="layoutSkinsRadio1">
                  <img class="custom-checkbox-card-img" src="views\admin\assets\\svg\layouts\layouts-sidebar-default.svg" alt="Image Description" />
                </label>
            ...
            <div class="text-center">
              <div class="custom-checkbox-card mb-2">
                ...
                <label class="custom-checkbox-card-label" for="layoutSkinsRadio2">
                  <img class="custom-checkbox-card-img" src="views\admin\assets\\svg\layouts\layouts-sidebar-dark.svg" alt="Image Description" />
                </label>
            ...
            <div class="text-center">
              <div class="custom-checkbox-card mb-2">
                ...
                <label class="custom-checkbox-card-label" for="layoutSkinsRadio3">
                  <img class="custom-checkbox-card-img" src="views\admin\assets\\svg\layouts\layouts-sidebar-light.svg" alt="Image Description" />
                </label>
            ...
            <div class="text-center">
              <div class="custom-checkbox-card mb-2">
                ...
                <label class="custom-checkbox-card-label" for="sidebarLayoutOptions1">
                  <img class="custom-checkbox-card-img" src="views\admin\assets\\svg\layouts\sidebar-default-classic.svg" alt="Image Description" />
                </label>
                <span class="custom-checkbox-card-text">Default</span>
              </div>
            </div>
            ...
            <div class="text-center">
              <div class="custom-checkbox-card mb-2">
                ...
                <label class="custom-checkbox-card-label" for="sidebarLayoutOptions2">
                  <img class="custom-checkbox-card-img" src="views\admin\assets\\svg\layouts\sidebar-compact.svg" alt="Image Description" />
                </label>
            ...
            <div class="text-center">
              <div class="custom-checkbox-card mb-2">
                ...
                <label class="custom-checkbox-card-label" for="sidebarLayoutOptions3">
                  <img class="custom-checkbox-card-img" src="views\admin\assets\\svg\layouts\sidebar-mini.svg" alt="Image Description" />
                </label>
            ...
            <div class="text-center">
              <div class="custom-checkbox-card mb-2">
                ...
                <label class="custom-checkbox-card-label" for="headerLayoutOptions1">
                  <img class="custom-checkbox-card-img" src="views\admin\assets\\svg\layouts\header-default-fluid.svg" alt="Image Description" />
                </label>
            ...
            <div class="text-center">
              <div class="custom-checkbox-card mb-2">
                ...
                <label class="custom-checkbox-card-label" for="headerLayoutOptions2">
                  <img class="custom-checkbox-card-img" src="views\admin\assets\\svg\layouts\header-default-container.svg" alt="Image Description" />
                </label>
            ...
            <div class="text-center">
              <div class="custom-checkbox-card mb-2">
                ...
                <label class="custom-checkbox-card-label" for="headerLayoutOptions3">
                  <img class="custom-checkbox-card-img" src="views\admin\assets\\svg\layouts\header-double-line-fluid.svg" alt="Image Description" />
                </label>
            ...
            <div class="text-center">
              <div class="custom-checkbox-card mb-2">
                ...
                <label class="custom-checkbox-card-label" for="headerLayoutOptions4">
                  <img class="custom-checkbox-card-img" src="views\admin\assets\\svg\layouts\header-double-line-container.svg" alt="Image Description" />
                </label>
    ...
    <header id="header" class="navbar navbar-expand-lg navbar-fixed navbar-height navbar-flush navbar-container navbar-bordered">
      <div class="navbar-nav-wrap">
        <div class="navbar-brand-wrapper">
          <!-- Logo -->
          <a class="navbar-brand" href="?ctr=home_admin" aria-label="Front">
            <img class="navbar-brand-logo" src="views\admin\assets\\svg\logos\logo.png" alt="Logo" />
            <img class="navbar-brand-logo-mini" src="views\admin\assets\\svg\logos\logo-short.svg" alt="Logo" />
          </a>
          <!-- End Logo -->
        </div>
            ...
            <form class="position-relative">
              ...
              <div id="searchDropdownMenu" class="hs-form-search-menu-content card dropdown-menu dropdown-card overflow-hidden">
                ...
                <div class="card-body-height py-3">
                  ...
                  <a class="dropdown-item my-2" href="index.html">
                    <div class="media align-items-center">
                      <img class="avatar avatar-xs avatar-circle mr-2" src="views\admin\assets\\img\160x160\img10.jpg" alt="Image Description" />
                      <div class="media-body text-truncate">
                        <span>Amanda Harvey
                  ...
                  <a class="dropdown-item my-2" href="index.html">
                    <div class="media align-items-center">
                      <img class="avatar avatar-xs avatar-circle mr-2" src="views\admin\assets\\img\160x160\img3.jpg" alt="Image Description" />
                      <div class="media-body text-truncate">
                            ...
                            <div class="row">
                              <div class="col-auto position-static">
                                <div class="d-flex align-items-center">
                                  ...
                                  <div class="avatar avatar-sm avatar-circle">
                                    <img class="avatar-img" src="views\admin\assets\\svg\brands\google.svg" alt="Image Description" />
                                  </div>
                                </div>
                              </div>
                              <div class="col ml-n3">
                            ...
                            <div class="row">
                              <div class="col-auto position-static">
                                <div class="d-flex align-items-center">
                                  ...
                                  <div class="avatar avatar-sm avatar-circle">
                                    <img class="avatar-img" src="views\admin\assets\\img\160x160\img7.jpg" alt="Image Description" />
                                  </div>
                                </div>
                              </div>
                              <div class="col ml-n3">
                            ...
                            <div class="row">
                              <div class="col-auto position-static">
                                <div class="d-flex align-items-center">
                                  ...
                                  <div class="avatar avatar-sm avatar-circle">
                                    <img class="avatar-img" src="views\admin\assets\\img\160x160\img5.jpg" alt="Image Description" />
                                  </div>
                                </div>
                              </div>
                              <div class="col ml-n3">
                            ...
                            <div class="row">
                              <div class="col-auto position-static">
                                <div class="d-flex align-items-center">
                                  ...
                                  <div class="avatar avatar-sm avatar-circle">
                                    <img class="avatar-img" src="views\admin\assets\\img\160x160\img8.jpg" alt="Image Description" />
                                  </div>
                                </div>
                              </div>
                              <div class="col ml-n3">
                  ...
                  <div class="card-body card-body-height">
                    ...
                    <div class="nav nav-pills flex-column">
                      <a class="nav-link" href="#">
                        <div class="media align-items-center">
                          <span class="mr-3">
                            <img class="avatar avatar-xs avatar-4by3" src="views\admin\assets\\svg\brands\atlassian.svg" alt="Image Description" />
                          </span>
                          <div class="media-body text-truncate">
                      ...
                      <a class="nav-link" href="#">
                        <div class="media align-items-center">
                          <span class="mr-3">
                            <img class="avatar avatar-xs avatar-4by3" src="views\admin\assets\\svg\brands\slack.svg" alt="Image Description" />
                          </span>
                          <div class="media-body text-truncate">
                            <span class="h5 mb-0">Slack
                              <span class="badge badge-primary badge-pill text-uppercase ml-1">Try</span></span>
                      ...
                      <a class="nav-link" href="#">
                        <div class="media align-items-center">
                          <span class="mr-3">
                            <img class="avatar avatar-xs avatar-4by3" src="views\admin\assets\\svg\brands\frontapp.svg" alt="Image Description" />
                          </span>
                          <div class="media-body text-truncate">
                      ...
                      <a class="nav-link" href="#">
                        <div class="media align-items-center">
                          <span class="mr-3">
                            <img class="avatar avatar-xs avatar-4by3" src="views\admin\assets\\svg\illustrations\review-rating-shield.svg" alt="Image Description" />
                          </span>
                          <div class="media-body text-truncate">
              ...
              <div class="hs-unfold">
                <a class="js-hs-unfold-invoker navbar-dropdown-account-wrapper" href="javascript:;" data-hs-unfold-options='{
                 ...
                 "type": "css-animation"
                  ...
                  <?php if ((isset($_SESSION['user']['vaitro']) && $_SESSION['user']['vaitro'] == 3) || (isset($_SESSION['user']['vaitro']) && $_SESSION['user']['vaitro'] == 2)) : ?>
                    <div class="avatar avatar-sm avatar-circle">
                      <img class="avatar-img" src="views\admin\assets\\img\160x160\<?= isset($_SESSION['user']['image']) ? $_SESSION['user']['image'] : "" ?>" alt="Image Description" />
                ...
                <div id="accountNavbarDropdown" class="hs-unfold-content dropdown-unfold dropdown-menu dropdown-menu-right navbar-dropdown-menu navbar-dropdown-account" style="width: 16rem">
                    ...
                    <?php if ((isset($_SESSION['user']['vaitro']) && $_SESSION['user']['vaitro'] == 3) || (isset($_SESSION['user']['vaitro']) && $_SESSION['user']['vaitro'] == 2)) : ?>
                      <div class="media align-items-center">
                        ...
                        <div class="media-body">
                          <span class="card-title h5"><?= isset($_SESSION['user']['hoten']) ? $_SESSION['user']['hoten'] : "" ?></span>
                          <span class="card-text"><?= isset($_SESSION['user']['email']) ? $_SESSION['user']['email'] : "" ?></span>
                        </div>
                      </div>
                    <?php endif ?>
                  </div>
                  ...
                  <a class="dropdown-item" href="?ctr=logout_acc">
              ...
              <div class="hs-unfold">
                <a class="js-hs-unfold-invoker navbar-dropdown-account-wrapper" href="javascript:;" data-hs-unfold-options='{
                 ...
                 "type": "css-animation"
                  ...
                  <div class="avatar avatar-sm avatar-circle">
                    <img class="avatar-img" src="views\admin\assets\\img\160x160\img6.jpg" alt="Image Description" />
                    <span class="avatar-status avatar-sm-status avatar-status-success"></span>
                  </div>
                </a>
                    ...
                    <div class="media align-items-center">
                      ...
                      <div class="media-body">
                        <span class="card-title h5">Htmlstream
                          <span class="badge badge-primary badge-pill text-uppercase ml-1">PRO</span></span>
                      ...
                      <div class="card-body card-body-height">
                        ...
                        <div class="nav nav-pills flex-column">
                          <a class="nav-link" href="#">
                            <div class="media align-items-center">
                              <span class="mr-3">
                                <img class="avatar avatar-xs" src="views\admin\assets\\svg\brands\atlassian.svg" alt="Image Description" />
                              </span>
                              <div class="media-body text-truncate">
                                <span class="h5 mb-0">Atlassian</span>
                                <span class="d-block font-size-sm text-body">Security and control across Cloud</span>
                          ...
                          <a class="nav-link" href="#">
                            <div class="media align-items-center">
                              <span class="mr-3">
                                <img class="avatar avatar-xs" src="views\admin\assets\\svg\brands\slack.svg" alt="Image Description" />
                              </span>
                              <div class="media-body text-truncate">
                                <span class="h5 mb-0">Slack
                                  <span class="badge badge-primary badge-pill text-uppercase ml-1">Try</span></span>
                          ...
                          <a class="nav-link" href="#">
                            <div class="media align-items-center">
                              <span class="mr-3">
                                <img class="avatar avatar-xs" src="views\admin\assets\\svg\brands\frontapp.svg" alt="Image Description" />
                              </span>
                              <div class="media-body text-truncate">
                                <span class="h5 mb-0">Frontapp</span>
                                <span class="d-block font-size-sm text-body">The inbox for teams</span>
                          ...
                          <a class="nav-link" href="#">
                            <div class="media align-items-center">
                              <span class="mr-3">
                                <img class="avatar avatar-xs" src="views\admin\assets\\svg\illustrations\review-rating-shield.svg" alt="Image Description" />
                              </span>
                              <div class="media-body text-truncate">
                                <span class="h5 mb-0">HS Support</span>
                                <span class="d-block font-size-sm text-body">Customer service and support</span>
            ...
            <ul class="navbar-nav navbar-nav-lg nav-tabs">
              ...
              <li class="navbar-vertical-aside-has-menu show">
                ...
                <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                  <li class="nav-item">
                    <a class="nav-link active" href="?ctr=home_admin" title="Default">
                      <span class="tio-circle nav-indicator-icon"></span>
              ...
              <li class="navbar-vertical-aside-has-menu">
                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:;" title="Apps">
                  ...
                  <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">Danh mục tour</span>
                </a>

                <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                  <li class="nav-item">
                    <a class="nav-link" href="?ctr=add-category" title="Kanban">
                      <span class="tio-circle nav-indicator-icon"></span>
                      <span class="text-truncate">Thêm danh mục</span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="?ctr=show_categories_admin" title="Kanban">
                      <span class="tio-circle nav-indicator-icon"></span>
              ...
              <li class="navbar-vertical-aside-has-menu">
                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:;" title="Apps">
                  ...
                  <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">Tour du lịch</span>
                </a>

                <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                  <li class="nav-item">
                    <a class="nav-link" href="?ctr=add-tour" title="Kanban">
                      <span class="tio-circle nav-indicator-icon"></span>
                      <span class="text-truncate">Thêm tour du lịch</span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="?ctr=show_tours_admin" title="Kanban">
                      <span class="tio-circle nav-indicator-icon"></span>
                      <span class="text-truncate">Danh sách tour du lịch</span>
                    </a>
                  </li>
                </ul>
              </li>
              ...
              <li class="navbar-vertical-aside-has-menu">
                ...
                <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                  <!-- <li class="nav-item">
                    <a class="nav-link" href="?ctr=add-customers" title="Kanban">
                      <span class="tio-circle nav-indicator-icon"></span>
                      <span class="text-truncate">Thêm khách hàng</span>
                    </a>
                  </li> -->
                  <li class="nav-item">
                    <a class="nav-link" href="?ctr=show_customers_admin" title="Kanban">
                      <span class="tio-circle nav-indicator-icon"></span>
              ...
              <li class="navbar-vertical-aside-has-menu">
                ...
                <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                  <li class="nav-item">
                    <a class="nav-link" href="?ctr=show_orders_admin" title="Kanban">
                      <span class="tio-circle nav-indicator-icon"></span>
              ...
              <?php if(isset($_SESSION['user']['vaitro']) && $_SESSION['user']['vaitro'] == 3) : ?>
                <li class="navbar-vertical-aside-has-menu">
                  <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:;" title="Apps">
                    <i class="tio-user nav-icon"></i>
                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">Nhân viên quản trị</span>
                  </a>

                  <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                    <li class="nav-item">
                      <a class="nav-link" href="?ctr=add-staff" title="Kanban">
                        <span class="tio-circle nav-indicator-icon"></span>
                        <span class="text-truncate">Thêm nhân viên</span>
                      </a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="?ctr=show_staffs_admin" title="Kanban">
                        <span class="tio-circle nav-indicator-icon"></span>
                        <span class="text-truncate">Danh sách nhân viên</span>
                      </a>
                    </li>
                  </ul>
                </li>
              ...
              <li class="navbar-vertical-aside-has-menu">
                ...
                <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                  <li class="nav-item">
                    <a class="nav-link" href="?ctr=show_comments_admin" title="Kanban">
                      <span class="tio-circle nav-indicator-icon"></span>
              ...
              <li class="navbar-vertical-aside-has-menu">
                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:;" title="Apps">
                  ...
                  <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">Bài viết</span>
                </a>

                <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                  <li class="nav-item">
                    <a class="nav-link" href="?ctr=add-news" title="Kanban">
                      <span class="tio-circle nav-indicator-icon"></span>
                      <span class="text-truncate">Thêm bài viết</span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="?ctr=show_news_admin" title="Kanban">
                      <span class="tio-circle nav-indicator-icon"></span>
              ...
              <li class="navbar-vertical-aside-has-menu">
                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:;" title="Apps">
                  ...
                  <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">Liên hệ</span>
                </a>

                <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                  <li class="nav-item">
                    <a class="nav-link" href="?ctr=show_contact_admin" title="Kanban">
                      <span class="tio-circle nav-indicator-icon"></span>
                      <span class="text-truncate">Danh sách liên hệ</span>
                    </a>
                  </li>
                </ul>
              </li>
              ...
              <li class="navbar-vertical-aside-has-menu">
                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:;" title="Apps">
                  ...
                  <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">Mã giảm giá</span>
                </a>

                <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                  <li class="nav-item">
                    <a class="nav-link" href="?ctr=add-voucher" title="Kanban">
                      <span class="tio-circle nav-indicator-icon"></span>
                      <span class="text-truncate">Thêm voucher</span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="?ctr=show_voucher_admin" title="Kanban">
                      <span class="tio-circle nav-indicator-icon"></span>
                      <span class="text-truncate">Danh sách voucher</span>
                    </a>
                  </li>
                </ul>
              </li>
              ...
              <li class="navbar-vertical-aside-has-menu">
                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:;" title="Apps">
                  ...
                  <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">Slide</span>
                </a>

                <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                  <li class="nav-item">
                    <a class="nav-link" href="?ctr=add-slide" title="Kanban">
                      <span class="tio-circle nav-indicator-icon"></span>
                      <span class="text-truncate">Thêm slide</span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="?ctr=show_slide_admin" title="Kanban">
                      <span class="tio-circle nav-indicator-icon"></span>
                      <span class="text-truncate">Danh sách slide</span>
                    </a>
                  </li>
                </ul>
              </li>
              ...
              <li class="navbar-vertical-aside-has-menu">
                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:;" title="Apps">
                  <i class="tio-wrench nav-icon"></i>
                  <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">Setting</span>
                </a>

                <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                  <li class="nav-item">
                    <a class="nav-link" href="?ctr=show-setting" title="Kanban">
                      <span class="tio-circle nav-indicator-icon"></span>
                      <span class="text-truncate">Danh sách cài đặt</span>
                    </a>
                  </li>
                </ul>
              </li>
              ...
              <li class="navbar-vertical-aside-has-menu nav-footer-item">
                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:;" title="Language">
                  <img class="avatar avatar-xss avatar-circle" src="views\admin\assets\\vendor\flag-icon-css\flags\1x1\vn.svg" alt="United States Flag" />
                ...
                <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                  <li class="nav-item">
                    <a class="nav-link" href="#" title="English (US)">
                      <img class="avatar avatar-xss avatar-circle mr-2" src="views\admin\assets\\vendor\flag-icon-css\flags\1x1\vn.svg" alt="Flag" />
                      English (US)
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="#" title="English (UK)">
                      <img class="avatar avatar-xss avatar-circle mr-2" src="views\admin\assets\\vendor\flag-icon-css\flags\1x1\gb.svg" alt="Flag" />
                      English (UK)
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="#" title="Deutsch">
                      <img class="avatar avatar-xss avatar-circle mr-2" src="views\admin\assets\\vendor\flag-icon-css\flags\1x1\de.svg" alt="Flag" />
                      Deutsch
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="#" title="Dansk">
                      <img class="avatar avatar-xss avatar-circle mr-2" src="views\admin\assets\\vendor\flag-icon-css\flags\1x1\dk.svg" alt="Flag" />
                      Dansk
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="#" title="Italiano">
                      <img class="avatar avatar-xss avatar-circle mr-2" src="views\admin\assets\\vendor\flag-icon-css\flags\1x1\it.svg" alt="Flag" />
                      Italiano
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="#" title="中文 (繁體)">
                      <img class="avatar avatar-xss avatar-circle mr-2" src="views\admin\assets\\vendor\flag-icon-css\flags\1x1\cn.svg" alt="Flag" />
                      中文 (繁體)
                    </a>
                  </li>
                </ul>
    ...
    <aside class="js-navbar-vertical-aside navbar navbar-vertical-aside navbar-vertical navbar-vertical-fixed navbar-expand-xl navbar-bordered">
      <div class="navbar-vertical-container">
        <div class="navbar-brand d-flex justify-content-center">
          ...
          <a class="navbar-brand" href="?ctr=home_admin" aria-label="Front">
            <img class="navbar-brand-logo-short" src="views\admin\assets\\svg\logos\logo-short.svg" alt="Logo" />
          </a>
