<?php include_once "views\admin\header_admin.php" ?>
    ...
    <main id="content" role="main" class="main">
      ...
      <div class="content container-fluid">
        ...
        <form method="POST" enctype="multipart/form-data" action="?ctr=save_add_news">
          <div class="row">
            <div class="col-lg-8">
              <!-- Card -->
              <div class="card mb-3 mb-lg-5">
                ...
                <div class="card-body">
                  ...
                  >
                  <textarea name="title_news" class="desc" cols="30" rows="10"></textarea>
                  ...
                  <label class="input-label"
                    ...
                    <span class="input-label-secondary">(Optional)</span></label
                  >
                  <textarea name="desc_news" class="desc" cols="30" rows="15"></textarea>
